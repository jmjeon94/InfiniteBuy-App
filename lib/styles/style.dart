...
// var bgColor = Color(0xff5756F1); // dark blue
const fgColor = Color(0xff18171D); // black-grey(toss-background)
const bgColor = Color(0xff0A090E); // black-grey(toss-foreground)
